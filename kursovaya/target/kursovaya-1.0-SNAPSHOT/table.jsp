...
<div id="content">
<%=new java.util.Date()%>
    <form action="SearchCurrencyServlet" method="get">
        Currency name: <input type="text" name = "currency" value="">
        <input type="submit" value="Search currency"/>
    </form>
    <form action="SearchDateServlet" method="get">
        Currency name: <input type="text" name = "date" value="">
...
<table border="3">
    ...
    <%
        ...
        try {
            ...
            Set<Currency> list = data.getCurrencies();
