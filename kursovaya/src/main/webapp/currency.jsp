...
<body>
<div id="header"><h1>ADD CURRENCY</h1></div>
<div id="sidebar">
...
<div id="content">
    ...
    <form action="AddCurrencyServlet" method="post">
        Currency name: <input type="text" name = "currency" value="">
        <input type="submit" value="Add currency"/>
    </form>

    <ul>
        <c:forEach var="с" items="${currencies}">
            <li>
                <form action="RemoveCurrencyServlet" method="post">
                    <a href="Info.jsp?Id=${с.getId()}"><c:out value="${с.getName()}" /></a>
                    <input type="hidden" name="Id" value="${с.getId()}">
